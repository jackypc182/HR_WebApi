...
namespace HR_WebApi.Helpers
{
    public class JwtHelpers
    {
        ...
        public string GenerateToken(string userName, int expireMinutes = 30)
        {
            ...
            var EmpIDType = Configuration.GetValue<string>("JwtSettings:EmpID");
            ...
            claims.Add(new Claim(EmpIDType, userName));
            #endregion
        ...
        public string GenerateToken(string userName, string Domain, int expireMinutes = 30)
        {
            var issuer = Configuration.GetValue<string>("JwtSettings:Issuer");
            var signKey = Configuration.GetValue<string>("JwtSettings:SignKey");
            var EmpIDType = Configuration.GetValue<string>("JwtSettings:EmpID");
